...
def contar_tipos_archivos(response_text):
    ...
    #return json.dumps(tipos_archivos)
    ...
    with open(nombre_archivo, 'a', newline='', encoding='utf-8') as archivo_csv:
        ...
        if not header_present:
            escritor_csv.writerow(['dominio', 'total_paginas', 'duracion_total',
                                   ...
                                   'pages_desc_short', 'pages_h1_dup', 'pages_img_1mb','id_escaneo','tiempo_medio','pages_err_orto','pages_alt_vacias'])  # Agregar nuevos campos
        ...
        for dominio, datos in resumen.items():
            ...
            escritor_csv.writerow([dominio, total_paginas, duracion_total,
                                   ...
                                   pages_title_long, pages_title_short, pages_title_dup, pages_desc_long,
                                   pages_desc_short, pages_h1_dup, pages_img_1mb, id_escaneo,tiempo_medio, pages_err_orto, pages_alt_vacias])  # Actualizado con nuevos campos
...
def guardar_en_csv_y_json(resultados, nombre_archivo_base, modo='w'):
    campos = ['fecha_escaneo', 'dominio', 'codigo_respuesta', 'tiempo_respuesta', 'pagina', 'parent_url',
              ...
              'desc_short', 'h1_duplicate', 'images_1MB','id_escaneo']
...
if __name__ == "__main__":
    ...
    urls_a_escanear = ["https://mc-mutuadeb.zonnox.net","http://zonnox.net"] #,"http://hispalis.net","http://circuitosaljarafe.com"]#,"https://4glsp.com"]
